...
\par
\textbf{String} lezxemes are recognized by their first character '"' in getToken function. The lexeme is then processed 
...
in switch located in getToken. Lexeme is processed in this function if none of the above token types criteria were met.
\par
